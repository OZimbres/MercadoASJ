...
public class JanelaEditaEstoque extends JDialog {
    ...
    //---=| Cadastro |=---//
    // Título Cadastro
    private JLabel tituloCadastro = new JLabel("Cadastro de Estoque");

    // Código produto
    private JLabel codigoLabel = new JLabel("Código Produto:");
    private JTextField codigoInput = new JTextField(20);
